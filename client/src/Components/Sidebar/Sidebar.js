    ...
    <>
      ...
      <div className="RespSidebar">
        <div className="Nav">
          ...
          >
            {" "}
            <img className="tweetIcon" src={tweet} alt="" />
          </Link>
          <Link
            to="/profile"
            style={{ textDecoration: "none", color: "black" }}
          >
            {" "}
            <PersonOutlineOutlinedIcon className="BottomLogo" />
          </Link>
          <Link
            to="/message"
            style={{ textDecoration: "none", color: "black" }}
          >
            <MailOutlineIcon className="BottomLogo" />
          </Link>

          <Link to="/logout" style={{ textDecoration: "none", color: "black" }}>
            {" "}
            <LogoutIcon className="BottomLogo" />
          </Link>
        </div>
      </div>
    </>
