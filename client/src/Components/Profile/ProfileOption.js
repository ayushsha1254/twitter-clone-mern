...
export default function ProfileOption() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/${JSON.parse(localStorage.getItem("user"))._id}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
      },
  ...
  return (
    <div className="ProfileOption">
      ...
      <div className="UserImg">
        ...
        />
        <button className="Editbtn" onClick={changeProfile}>
          Edit profile
        </button>
      </div>
        ...
        {posts.map((data) => (
          <div className="Post">
            <div className="PostAvatar">
              <Avatar src={user.Photo ? user.Photo : picLink} />
            </div>
