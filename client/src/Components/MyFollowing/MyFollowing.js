  ...
  return (
    <>
      <section className="MyFollowing">
        <div className="side" style={{ position: "relative", top: "-5rem" }}>
          <Sidebar />
        </div>
        ...
        <div className="Feed">
          <div className="Feed_header" style={{ marginTop: "-6.5rem" }}>
            ...
            <div className="subFeed_header">
              ...
              <Link to="/followingpost" style={{ textDecoration: "none" }}>
                <h3 className="activeLink">Following</h3>
              </Link>
            </div>
          </div>
          {/* Tweet box */}
          ...
          {data.map((posts) => (
            <div className="Post">
              ...
              {openComment && (
                <Comment postDetails={posts} closeComment={setOpenComment} />
              )}
              {openViewAllComment && (
                <Comment
                  postDetails={posts}
                  closeViewAllComment={setOpenViewAllComment}
                />
              )}
            </div>
          ))}
        ...
        <div
          className="wid"
          style={{ position: "fixed", top: "1rem", left: "62rem" }}
        >
          {" "}
          <Widget />{" "}
        </div>
